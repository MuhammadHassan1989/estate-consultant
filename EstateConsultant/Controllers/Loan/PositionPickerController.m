...
@implementation PositionPickerController
...
{
    NSInteger section = [_buildings indexOfObject:position.unit.building];
    NSInteger row = [(NSArray *)[_positionArray objectAtIndex:section] indexOfObject:position];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.calculatorController.position = position;
    self.calculatorController.house = nil;
